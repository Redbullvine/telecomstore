...
const purchasable = { sku: "PUBLIC-1", price_mode: "fixed", public_price: 12.5, checkout_active: true };
const quote = { sku: "PUBLIC-2", price_mode: "request_quote", public_price: null, checkout_active: false };
