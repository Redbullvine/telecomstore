...
test("template contains all 206 listed merchandise prices and checkout stays disabled", () => {
...
test("public pricing JSON mirrors all listed prices while all checkout stays off", () => {
